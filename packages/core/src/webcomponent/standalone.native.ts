...
const pluginRegistry: Record<string, () => Promise<any>> = {
  ...
  'formatPainter': () => import("../../../plugins/format-painter/src/FormatPainterPlugin.native").then(m => m.FormatPainterPlugin()),
  'format-painter': () => import("../../../plugins/format-painter/src/FormatPainterPlugin.native").then(m => m.FormatPainterPlugin()),
  'formatpainter': () => import("../../../plugins/format-painter/src/FormatPainterPlugin.native").then(m => m.FormatPainterPlugin()),
