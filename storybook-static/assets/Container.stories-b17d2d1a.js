import{a9 as e,j as g,G as f,a as r}from"./index-ce0e40fa.js";import"./index-93f6b7ae.js";import"./index-c197feae.js";const z={title:"UI/Container",component:e,argTypes:{size:{control:"select",options:["sm","md","lg","xl"]}}},n=s=>g(e,{size:s.size,style:{padding:24,background:"#f8fafc",border:"1px solid #e2e8f0",borderRadius:12},children:["Container content (",s.size,")"]});n.args={size:"md"};const a=()=>g(f,{style:{display:"grid",gap:10},children:[r(e,{size:"sm",style:{background:"#f1f5f9",padding:12},children:"Small"}),r(e,{size:"md",style:{background:"#f1f5f9",padding:12},children:"Medium"}),r(e,{size:"lg",style:{background:"#f1f5f9",padding:12},children:"Large"}),r(e,{size:"xl",style:{background:"#f1f5f9",padding:12},children:"Extra Large"})]});var i,o,d;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`(args: any) => <Container size={args.size} style={{
  ...
  </Grid>`,...(c=(l=a.parameters)==null?void 0:l.docs)==null?void 0:c.source}}};const C=["Default","SizeComparison"];export{n as Default,a as SizeComparison,C as __namedExportsOrder,z as default};
