...
| `UIPresence`, `UIProgress`, `UIMarquee`, `UIAnimatedText`, `UIScrollArea`, `UISeparator`, `UISlot`, `UIToolbar`, `UIPortal`, `UIVisuallyHidden` | Component class exports | Accessibility/layout utilities |
