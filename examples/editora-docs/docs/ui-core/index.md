...
| `UIPresence`, `UIProgress`, `UIMarquee`, `UIAnimatedText`, `UIDock`, `UIOrbiter`, `UIScrollArea`, `UISeparator`, `UISlot`, `UIToolbar`, `UIPortal`, `UIVisuallyHidden` | Class exports | Utility primitives |
